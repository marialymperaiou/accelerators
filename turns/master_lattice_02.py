...
print t
TURNS = t[1]
print "Number of tracking turns: %d" %(TURNS)
...
DQ2 = Qy[0]	
print "Chromaticities Q'x = %d, Q'y = %d \n" %(DQ1, DQ2)								
...
start, x= 2e-3, px=0, y= 2e-3, py=0, t= 0, pt = 1e-5;            
...
with open(fname, 'w') as fid:
	...
	#tracking
	fid.write('track,file=track%d_master%d.out,dump;'%(TURNS, DQ1))
	fid.write(track)
